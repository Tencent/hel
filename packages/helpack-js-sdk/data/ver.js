...
exports.getVer = function (options) {
  ...
  return {
    ...
    src_map: {
      ...
      staticCssSrcList: [],
      staticJsSrcList: ['https://tnfe.gtimg.com/hel-mono/l1/react-hel/v3.js'],
      relativeCssSrcList: [],
      relativeJsSrcList: [],
      headAssetList: [
        {
...
exports.getOtherCdnVer = function (options) {
  ...
  return {
    ...
    src_map: {
      ...
      srvModSrcList: ['https://unpkg.com/@hel-demo/mono-libs@1.0.1/hel_dist/srv/index.js'],
...
exports.getWeDataVer = function () {
  return {
    ...
    src_map: {
      ...
      extractMode: 'all',
      iframeSrc: '',
      chunkCssSrcList: ['https://unpkg.com/@hel-demo/mono-comps@0.1.3/hel_dist/static/css/main.6c1edb90.css'],
      chunkJsSrcList: ['https://unpkg.com/@hel-demo/mono-comps@0.1.3/hel_dist/static/js/main.06c44ae8.js'],
      staticCssSrcList: [],
      staticJsSrcList: [
