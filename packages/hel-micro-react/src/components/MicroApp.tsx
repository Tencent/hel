...
|--------------------------------------------------------------------------
*/
import type { IMicroAppProps, IInnerRemoteModuleProps, IMicroAppLegacyProps, AnyRecord, ILocalCompProps } from '../types';
...
export type LocalCompType = (
  props: ILocalCompProps,
  ref?: React.Ref<any>,
) => React.ReactElement | null;
 ...
 */
export const MicroAppLegacyMemo = React.memo(MicroAppLegacy, () => true) as
  <T extends AnyRecord = AnyRecord>(props: IMicroAppLegacyProps<T>) => React.ReactElement;
