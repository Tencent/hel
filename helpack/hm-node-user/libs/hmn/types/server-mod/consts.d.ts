 ...
 * 代理文件模板关键字：是否使用假模块
 */
export declare const KW_USE_FAKE = "{{USE_FAKE}}";
/**
 * 代理文件模板关键字：原始模块导入语句
 */
export declare const KW_REQUIRE_RAW_MOD = "{{REQUIRE_RAW_MOD}}";
/**
 * 代理文件模板关键字：hel模块名
 */
export declare const KW_HEL_MOD_NAME = "{{HEL_MOD_NAME}}";
/**
 * 代理文件模板关键字：hel平台值
 */
export declare const KW_HEL_PLATFORM = "{{HEL_PLATFORM}}";
export declare const KW_RAW_MOD_NAME = "{{RAW_MOD_NAME}}";
/**
...
/**
 * 编译后的代理文件内容，
 * 注：jest 环境中载入 hel 模块不走此文件，走的是 jest.doMock 替换
 */
