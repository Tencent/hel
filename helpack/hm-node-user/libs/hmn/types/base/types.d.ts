...
import type { BeforePreloadOnce, GetMeta, GetSocketUrlWhenReconnect, IModShape, IDownloadNodeServerModFilesOptions, IDownloadServerModFilesOptions, IFetchModMetaBaseOptions, IFetchModMetaOptions, IFileDownloadInfo, IGetModDescOptions, IGetModRootDirDataOptions, IHMNHooks, IImportModByMetaOptions, IImportModByMetaSyncOptions, IImportModByNodePathOptions, IImportModOptions, IImportNodeModResult, IMapModOptions, IMockAutoDownloadOptions, IModDesc, IModIns, IModManagerItem, IModManagerItemBase, INameData, INodeModFallbackConf, INodeModMapper, IOnFilesReadyParams, IPlatformConfig, IPrepareFilesParams, IRegisterPlatformConfig, IResolveModResult, ISDKGlobalBaseConfig, ISDKGlobalConfig, IStdNodeModMapper, IWebFileInfo, OnFilesReady, OnFilesReadySync, PrepareFiles, PrepareFilesSync, IShouldAcceptVersionParams } from './types-srv-mod';
export declare type DictData = Record<string, any>;
export type { IFetchModMetaOptions, IFetchModMetaBaseOptions, ISDKGlobalConfig, IModShape, IDownloadServerModFilesOptions, IDownloadNodeServerModFilesOptions, IHMNHooks, IMapModOptions, INodeModMapper, IStdNodeModMapper, INodeModFallbackConf, IResolveModResult, IWebFileInfo, IFileDownloadInfo, IModIns, IPrepareFilesParams, PrepareFiles, IOnFilesReadyParams, OnFilesReady, OnFilesReadySync, PrepareFilesSync, IRegisterPlatformConfig, IImportModByMetaSyncOptions, IImportModByMetaOptions, IImportModByNodePathOptions, IImportNodeModResult, ISDKGlobalBaseConfig, IModManagerItemBase, IModDesc, IModManagerItem, IImportModOptions, INameData, IPlatformConfig, IMockAutoDownloadOptions, IGetModRootDirDataOptions, IMeta, GetMeta, IGetModDescOptions, IShouldAcceptVersionParams, };
/** 形如：xxx-mod, @scope/xxx-mod */
export declare type PkgName = string;
/** 形如：xxx-hel-mod, @scope/xxx-hel-mod  */
export declare type HelModName = string;
/** 形如：xxx-hel-mod/sub-mod1, xxx-hel-mod/sub-mod2, 不带子路径时， HelModName 等于 HelModPath */
export declare type HelModPath = string;
/** 即可能是单纯的 hel 模块名，也可能是带子路径的 hel 模块名 */
export declare type HelModOrPath = string;
/** 平台值 */
...
export declare type ModConfDict = Record<string, IModConf>;
/** 组相关配置 */
...
declare type ExcludeProps = 'reporter' | 'view2assetName' | 'assetNameInfos' | 'assetName2view' | 'view2appName' | 'mod2conf' | 'modNames' | 'helpackApiUrl' | 'receiveAllMod' | 'platform' | 'isActive' | 'registrationSource' | 'helSdkSrc' | 'helEntrySrc' | 'isPreloadMode' | 'helpackSocketUrl' | 'beforePreloadOnce' | 'careAllModsChange';
/**
...
declare type ExcludePreloadProps = 'isApiUrlOverwrite' | 'helMetaBackupFilePath' | 'helpackSocketUrl' | 'beforePreloadOnce' | 'careAllModsChange' | 'getHelRenderParams' | 'shouldAcceptVersion' | 'getEnvInfo' | 'api' | 'regHooks' | 'bizHooks' | 'confHooks';
/**
...
export declare type THookType = 'onInitialHelMetaFetched' | 'onHelModLoaded' | 'onMessageReceived';
